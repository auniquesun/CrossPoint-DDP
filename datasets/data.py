...
def load_modelnet_data(partition):
    DATA_DIR = '/change/to/your/modelnet40_ply_hdf5_2048/path'
...
def load_ScanObjectNN(partition):
    BASE_DIR = '/change/to/your/ScanObjectNN/path'
...
def load_shapenet_data():
    DATA_DIR = '/change/to/your/ShapeNet/parent/path'
    all_filepath = []
...
def get_render_imgs(pcd_path):
    ...
    # change the following array indices according to your dataset path
