...
def load_data_partseg(partition):
    download_shapenetpart()   # you can prepare the data in advance
    BASE_DIR = '/your/path/to/CrossPoint-DDP'
    DATA_DIR = os.path.join(BASE_DIR, 'data')   # adjust the dir according to your setting
    all_data = []
    all_label = []
    all_seg = []
...
class ShapeNetPart(Dataset):
    def __init__(self, num_points, partition='train', class_choice=None):
        ...
        if self.class_choice != None:
            print('------\n')
            print('Entering self.class_choice != None\n')
            print('------')
