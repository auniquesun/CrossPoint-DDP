...
# pueue add -g crosspoint python ft_crosspoint.py --exp_name ft-crosspoint-SO-0 \
...
# pueue add -g crosspoint python ft_crosspoint.py --exp_name ft-crosspoint-SO-1 \
#         --ft_dataset ScanObjectNN --num_ft_points 1024 \
#         --batch_size 600 --test_batch_size 600 --print_freq 50\
#         --num_workers 1 --num_classes 15 --resume --model dgcnn \
#         --model_path checkpoints/crosspoint_dgcnn_cls3/models/best_model.pth \
...
pueue add -g crosspoint python ft_crosspoint.py --exp_name ft-crosspoint-SO-2 \
        --ft_dataset ScanObjectNN --num_ft_points 1024 \
        --batch_size 600 --test_batch_size 600 --print_freq 50\
        --num_workers 1 --num_classes 15 --resume --model dgcnn \
        --model_path checkpoints/crosspoint_dgcnn_cls3/models/best_model.pth \
